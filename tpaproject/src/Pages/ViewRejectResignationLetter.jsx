...
const ViewRejectResignationLetter = () => {
  ...
  return (
    <>
      <div>ViewRejectResignationLetter</div>
        <div>
        <table>
                <thead>
                <tr>
...
export default ViewRejectResignationLetter
