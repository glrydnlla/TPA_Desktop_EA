...
const UpdateResignationLetterStatus = () => {
    ...
    const dbRef = collection(db, "resignationLetter");
  ...
  return (
    <>
        <div>Update Resignation Letter Status</div>
        <div>Resignation Letter ID: {p?.id}</div>
        ...
        <span>Resignation Letter Status </span>
...
export default UpdateResignationLetterStatus