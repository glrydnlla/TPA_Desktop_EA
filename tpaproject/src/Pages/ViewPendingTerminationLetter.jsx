...
const ViewPendingTerminationLetter = () => {
  ...
  return (
    <>
      <div>ViewPendingTerminationLetter</div>
        <div>
        <table>
                <thead>
                <tr>
...
export default ViewPendingTerminationLetter