...
const ViewPendingWarningLetter = () => {
  ...
  return (
    <>
      <div>ViewPendingWarningLetter</div>
        <div>
        <table>
                <thead>
                <tr>
...
export default ViewPendingWarningLetter